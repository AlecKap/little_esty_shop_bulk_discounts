...
def test_data
    ...
    @bulk_disc2 = BulkDiscount.create!(name: "Great Deals Dehlight", discount_percent: 0.15, quantity_threshold: 15, merchant_id: @merchant1.id)
    @bulk_disc3 = BulkDiscount.create!(name: "Mulah Savah", discount_percent: 0.20, quantity_threshold: 20, merchant_id: @merchant1.id)
    @bulk_disc4 = BulkDiscount.create!(name: "Massive Money Saver", discount_percent: 0.30, quantity_threshold: 25, merchant_id: @merchant1.id)
end
